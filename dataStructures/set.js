...
*** Exercises:
    Modify your set to take a max capacity and return a string 
    if you try to add an element when there's no more room
    mySet.add(value)
...
function Set(capacity) {
  ...
  Set.prototype.add = function(value) {
    if(this.has(value)) return "Already present";
    else if (this._count < this._capacity) {
      this._storage[value] = true;
      this._count++;
      return this;
    }
    return "Set already reached max limit"
  };
  // // Time complexity: O(1)
  ...
  * exercises adapted from Algorithms, 4th Edition by Robert Sedgewick and Kevin Wayne
  ...
  const set1 = new Set(14);
  const set2 = new Set(14);
  set1.add(1)
  set1.add(2)
  set1.add(3)
  set2.add(2)
